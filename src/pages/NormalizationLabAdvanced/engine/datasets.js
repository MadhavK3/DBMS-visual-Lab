...
export const datasets = {
  college: {
    ...
    columns: ['StudentID', 'StudentName', 'Skills', 'Course', 'Professor', 'Department'],
    rows: [
      ['S101', 'Alice', 'C++, Java', 'DBMS', 'Dr. Smith', 'CS'],
      ['S101', 'Alice', 'C++, Java', 'OS', 'Dr. Lee', 'CS'],
      ['S102', 'Bob', 'Python', 'DBMS', 'Dr. Smith', 'CS'],
      ['S102', 'Bob', 'Python', 'Networks', 'Dr. Patel', 'IT'],
      ['S103', 'Charlie', 'Node, React', 'OS', 'Dr. Lee', 'CS'],
      ['S103', 'Charlie', 'Node, React', 'AI', 'Dr. Kumar', 'CS'],
      ['S104', 'Diana', 'Go, Python', 'Networks', 'Dr. Patel', 'IT'],
      ['S104', 'Diana', 'Go, Python', 'DBMS', 'Dr. Smith', 'CS'],
    ],
    primaryKey: ['StudentID', 'Course', 'Skills'],
    functionalDependencies: [
      { from: ['StudentID'], to: ['StudentName'] },
      { from: ['Course'], to: ['Professor'] },
      { from: ['Professor'], to: ['Department'] },
      { from: ['StudentID', 'Course', 'Skills'], to: ['StudentName', 'Professor', 'Department'] },
    ],
  ...
  company: {
    ...
    columns: ['EmployeeID', 'EmployeeName', 'Certifications', 'Project', 'Manager', 'Department'],
    rows: [
      ['E01', 'John', 'AWS, Azure', 'Alpha', 'Mr. Wilson', 'Engineering'],
      ['E01', 'John', 'AWS, Azure', 'Beta', 'Ms. Davis', 'Marketing'],
      ['E02', 'Sarah', 'PMP', 'Alpha', 'Mr. Wilson', 'Engineering'],
      ['E02', 'Sarah', 'PMP', 'Gamma', 'Mr. Chen', 'Engineering'],
      ['E03', 'Mike', 'Scrum, Agile', 'Beta', 'Ms. Davis', 'Marketing'],
      ['E03', 'Mike', 'Scrum, Agile', 'Delta', 'Mr. Wilson', 'Engineering'],
      ['E04', 'Emma', 'GCP', 'Gamma', 'Mr. Chen', 'Engineering'],
      ['E04', 'Emma', 'GCP', 'Alpha', 'Mr. Wilson', 'Engineering'],
    ],
    primaryKey: ['EmployeeID', 'Project', 'Certifications'],
    functionalDependencies: [
      { from: ['EmployeeID'], to: ['EmployeeName'] },
      { from: ['Project'], to: ['Manager'] },
      { from: ['Manager'], to: ['Department'] },
      { from: ['EmployeeID', 'Project', 'Certifications'], to: ['EmployeeName', 'Manager', 'Department'] },
    ],
  },
  ...
  ecommerce: {
    ...
    columns: ['OrderID', 'CustomerName', 'ShippingOptions', 'Product', 'Supplier', 'Price'],
    rows: [
      ['ORD1', 'Alice', 'Standard, Express', 'Laptop', 'TechCorp', '999'],
      ['ORD1', 'Alice', 'Standard, Express', 'Mouse', 'GadgetInc', '29'],
      ['ORD2', 'Bob', 'Standard', 'Laptop', 'TechCorp', '999'],
      ['ORD2', 'Bob', 'Standard', 'Keyboard', 'GadgetInc', '79'],
      ['ORD3', 'Charlie', 'Same-Day, Express', 'Phone', 'TechCorp', '699'],
      ['ORD3', 'Charlie', 'Same-Day, Express', 'Mouse', 'GadgetInc', '29'],
      ['ORD4', 'Alice', 'Standard', 'Tablet', 'TechCorp', '499'],
      ['ORD4', 'Alice', 'Standard', 'Keyboard', 'GadgetInc', '79'],
    ],
    primaryKey: ['OrderID', 'Product', 'ShippingOptions'],
    functionalDependencies: [
      { from: ['OrderID'], to: ['CustomerName'] },
      { from: ['Product'], to: ['Supplier', 'Price'] },
      { from: ['OrderID', 'Product', 'ShippingOptions'], to: ['CustomerName', 'Supplier', 'Price'] },
    ],
  },
  ...
  hospital: {
    ...
    columns: ['PatientID', 'PatientName', 'Allergies', 'Doctor', 'Department', 'Room'],
    rows: [
      ['P01', 'Raj', 'Peanuts, Dust', 'Dr. Mehta', 'Cardiology', 'R101'],
      ['P01', 'Raj', 'Peanuts, Dust', 'Dr. Sharma', 'Neurology', 'R205'],
      ['P02', 'Priya', 'None', 'Dr. Mehta', 'Cardiology', 'R102'],
      ['P02', 'Priya', 'None', 'Dr. Gupta', 'Orthopedics', 'R301'],
      ['P03', 'Amit', 'Pollen', 'Dr. Sharma', 'Neurology', 'R206'],
      ['P03', 'Amit', 'Pollen', 'Dr. Mehta', 'Cardiology', 'R103'],
      ['P04', 'Neha', 'Dairy, Gluten', 'Dr. Gupta', 'Orthopedics', 'R302'],
      ['P04', 'Neha', 'Dairy, Gluten', 'Dr. Sharma', 'Neurology', 'R207'],
    ],
    primaryKey: ['PatientID', 'Doctor', 'Allergies'],
    functionalDependencies: [
      { from: ['PatientID'], to: ['PatientName'] },
      { from: ['Doctor'], to: ['Department'] },
      { from: ['PatientID', 'Doctor', 'Allergies'], to: ['PatientName', 'Department', 'Room'] },
    ],
  },
  ...
  bigdata: {
    ...
    columns: ['Region', 'Country', 'StoreID', 'StoreManager', 'PaymentMethods', 'ProductID', 'ProductName', 'Category', 'Supplier', 'UnitsSold'],
    rows: [
      ['North America', 'USA', 'ST-101', 'Alice Johnson', 'Card, Cash', 'P-1', 'Ultra Laptop', 'Electronics', 'TechCorp', '520'],
      ['North America', 'USA', 'ST-101', 'Alice Johnson', 'Card, Cash', 'P-2', 'Ergo Mouse', 'Electronics', 'TechCorp', '1250'],
      ['North America', 'Canada', 'ST-102', 'Bob Smith', 'Card', 'P-1', 'Ultra Laptop', 'Electronics', 'TechCorp', '410'],
      ['Europe', 'UK', 'ST-201', 'Charlie Brown', 'Card, Wallet', 'P-3', 'Oak Desk', 'Furniture', 'WoodCrafters', '85'],
      ['Europe', 'UK', 'ST-201', 'Charlie Brown', 'Card, Wallet', 'P-4', 'Office Chair', 'Furniture', 'WoodCrafters', '210'],
      ['Europe', 'Germany', 'ST-202', 'Diana Prince', 'Cash', 'P-2', 'Ergo Mouse', 'Electronics', 'TechCorp', '980'],
      ['Asia', 'Japan', 'ST-301', 'Evan Lee', 'Wallet, Card', 'P-1', 'Ultra Laptop', 'Electronics', 'TechCorp', '630'],
      ['Asia', 'Japan', 'ST-301', 'Evan Lee', 'Wallet, Card', 'P-5', 'HDMI Cable', 'Accessories', 'CableWorks', '3200'],
    ],
    primaryKey: ['StoreID', 'ProductID', 'PaymentMethods'],
    functionalDependencies: [
      { from: ['StoreID'], to: ['StoreManager', 'Country'] },
      { from: ['ProductID'], to: ['ProductName', 'Category', 'Supplier'] },
      { from: ['Country'], to: ['Region'] },
      { from: ['StoreID', 'ProductID', 'PaymentMethods'], to: ['StoreManager', 'Country', 'Region', 'ProductName', 'Category', 'Supplier', 'UnitsSold'] },
    ],
  },
}
